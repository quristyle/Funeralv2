        ...
        <DropdownMenuLabel class="flex items-center p-3">
          ...
          <div class="ml-2 w-full flex flex-col gap-1">
            ...
            >
              ...
              <Badge
                v-if="companyName"
                class="text-[9px] px-1.5 py-0.5 bg-primary/10 text-primary border-primary/20 max-w-[90px] truncate shrink-0"
              >
                {{ companyName }}
              </Badge>
              <Badge
                v-if="deptName"
                class="text-[9px] px-1.5 py-0.5 bg-muted text-muted-foreground border max-w-[90px] truncate shrink-0"
              >
                {{ deptName }}
              </Badge>
              <slot name="tagText">
            ...
            <div
              class="text-xs font-normal text-muted-foreground/80 truncate max-w-[180px]"
            >
              {{ userEmail }}
            </div>
