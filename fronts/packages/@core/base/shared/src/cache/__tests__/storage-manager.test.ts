...
describe('storageManager', () => {
  ...
  it('should clear expired items', async () => {
    await storageManager.setItem('user', { age: 30, name: 'John Doe' }, 1000); // 1초 후 만료
  ...
  it('should not clear non-expired items', async () => {
    await storageManager.setItem('user', { age: 30, name: 'John Doe' }, 10_000); // 10초 후 만료
  ...
  it('should handle multiple items with different expiry times', async () => {
    await storageManager.setItem('user1', { age: 30, name: 'John Doe' }, 1000); // 1초 후 만료
