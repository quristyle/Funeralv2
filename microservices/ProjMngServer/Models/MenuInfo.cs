...
public class MenuInfo : BaseModel {
  ...
  public string mnu_cd { get; set; } = string.Empty;

  public string mnu_nm { get; set; } = string.Empty;
  public string mnu_url { get; set; } = string.Empty;

  public decimal? disp_seq { get; set; }
  public string parent_mnu_cd { get; set; } = string.Empty;
  public string mnu_grp_yn { get; set; } = string.Empty;
  public string pgm_id { get; set; } = string.Empty;

  public string mnu_id { get; set; } = string.Empty;
  public string use_yn { get; set; } = string.Empty;
  public string pgm_ty { get; set; } = string.Empty;



  public string mnu_desc { get; set; } = string.Empty;
...
public class BaseModel {
  ...
  public string cre_user { get; set; } = string.Empty;
