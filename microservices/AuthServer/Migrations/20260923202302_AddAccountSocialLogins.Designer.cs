...
namespace AuthServer.Migrations
{
    ...
    [Migration("20260923202302_AddAccountSocialLogins")]
    partial class AddAccountSocialLogins
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthServer.Entities.AccountSocialLogin", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("DisplayName")
                        ...
                        .HasComment("공급자가 알려 준 이름·별명. 「연결된 소셜 계정」 목록에서 어느 줄을\n            떼어야 하는지를 이 값으로 알아본다.");

                    b.Property<string>("Email")
                        .HasColumnType("text")
                        .HasColumnName("email")
                        .HasComment("공급자가 알려 준 이메일. 참고용이다 — 이 값으로 주인을 찾지 않는다.\n            공급자가 안 주면 비어 있다.");
                    ...
                    b.Property<DateTime?>("LastLoginAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_login_at")
                        .HasComment("마지막으로 이 소셜 계정으로 들어온 시각 (UTC). 한 번도 안 썼으면 null.");

                    b.Property<string>("Provider")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("provider")
                        .HasComment("공급자 열쇠 — google · naver · kakao.\n            설정(Auth:Social:Providers)의 칸 이름과 같아야 한다.");

                    b.Property<string>("ProviderUserId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("provider_user_id")
                        .HasComment("공급자가 지어 준 사용자 번호. 로그인은 이 값으로 주인을 찾는다\n            (머리말 참고). 공급자 안에서만 고유하므로  와 짝으로 쓴다.");
                    ...
                    b.ToTable("account_social_logins", "scom", t =>
                        {
                            t.HasComment("계정 하나에 연결된 소셜 계정 한 개.\n             구글 · 네이버 · 카카오가 모두 여기 한 줄로 남는다.");
                        });
                });

            modelBuilder.Entity("AuthServer.Entities.AccountWebAuthnCredential", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("AccountId")
                        ...
                        .HasColumnType("text")
                        .HasColumnName("account_id")
                        .HasComment("이 패스키의 주인.");

                    b.Property<int>("Algorithm")
                        .HasColumnType("integer")
                        .HasColumnName("algorithm")
                        .HasComment("서명 알고리즘 (COSE 식별자). -7 = ES256, -257 = RS256.\n            검증할 때 어느 열쇠 형식으로 읽을지를 이 값이 정한다.");

                    b.Property<string>("Attachment")
                        .HasColumnType("text")
                        .HasColumnName("attachment")
                        .HasComment("인증기 종류 — platform(기기에 붙박이: 지문·얼굴) ·\n            cross-platform(따로 꽂는 보안 열쇠).");
                    ...
                    b.Property<string>("CredentialId")
                        ...
                        .HasComment("인증기가 지어 준 자격 증명 아이디 (base64url).\n            로그인할 때 브라우저가 이 값을 들고 오므로 여기로 찾는다.");
                    ...
                    b.ToTable("account_webauthn_credentials", "scom", t =>
                        {
                            t.HasComment("계정 하나에 등록된 패스키(WebAuthn 인증기) 한 개.\n             휴대폰 지문·얼굴, 윈도우 Hello, 보안 열쇠가 모두 여기 한 줄로 남는다.");
                        });
                });
