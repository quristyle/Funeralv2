...
| 사업장 기상 감시 | `ghub` DB 의 `weather_*` 표 15개 · `microservices/GhubServer` |
| 설비 · 수요반응 | `fronts/apps/jsini-portal/src/api/helpdesk/oadr.ts` · ApiGateway 의 `oadr-route` · `HelpDeskServer/HealthCheckWorker.cs` |
