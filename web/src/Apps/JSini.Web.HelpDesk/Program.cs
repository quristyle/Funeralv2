using JSini.Web.HelpDesk;
using JSini.Web.HelpDesk.Components;
using JSini.Web.Components;

var builder = WebApplication.CreateBuilder(args);

// 이 앱이 자기를 어떻게 부르는지. 라우트 접두사가 여기서 나온다.
var module = new HelpDeskModule();
...
// **이 앱은 /helpdesk 아래에서 산다.**
//
// 셸이 /helpdesk/... 를 접두사를 떼지 않고 그대로 넘긴다. 여기서 PathBase 를
